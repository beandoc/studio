  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 h-svh bg-sidebar transition-[width] ease-linear",
            "w-[var(--sidebar-width)]",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 [&>svg]:size-5", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col transition-[margin-left] duration-200 lg:ml-[var(--sidebar-width)]",
        state === 'collapsed' && 'lg:ml-[var(--sidebar-width-icon)]',
        className
      )}
      {...props}
    />
